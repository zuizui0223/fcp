#!/usr/bin/env python3
"""Verify the v0.8 random-slope/meta benchmark against its frozen receipt."""
...
SUMMARY_KEYS = (
    ...
    "max_meta_mean_null_fpr",
    "max_meta_heterogeneity_null_fpr",
    "max_meta_omnibus_null_fpr",
    "max_calibrated_meta_mean_null_fpr",
    "max_calibrated_meta_heterogeneity_null_fpr",
    "max_calibrated_meta_omnibus_null_fpr",
    "effect_0_4_reversal0_equal_detection_range",
    "effect_0_4_reversal0_common_slope_detection_range",
    "effect_0_4_reversal0_meta_omnibus_detection_range",
    "effect_0_4_reversal0_calibrated_meta_omnibus_detection_range",
    "effect_0_4_reversal0_5_equal_detection_range",
    "effect_0_4_reversal0_5_common_slope_detection_range",
    "effect_0_4_reversal0_5_meta_heterogeneity_detection_range",
    "effect_0_4_reversal0_5_meta_omnibus_detection_range",
    "effect_0_4_reversal0_5_calibrated_meta_heterogeneity_detection_range",
    "effect_0_4_reversal0_5_calibrated_meta_omnibus_detection_range",
    "effect_0_8_reversal0_5_equal_detection_range",
    "effect_0_8_reversal0_5_meta_omnibus_detection_range",
    "effect_0_8_reversal0_5_calibrated_meta_omnibus_detection_range",
)
