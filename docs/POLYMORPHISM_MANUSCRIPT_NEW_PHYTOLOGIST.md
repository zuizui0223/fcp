...
- Results: 1,807 words
- Discussion: 2,220 words
- Main text (Introduction through Discussion): 7,426 words
- Figures: 5
- Tables: 1
...
### Generality in what varies, uncertainty in where it is sorted
