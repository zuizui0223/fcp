...
| Table S6 | `docs/supporting/jbi_table_s6_frozen_classification_manifest.csv` | 34 | `e3f51b381ffb10c2ad13a24245c9f3b9801dde7cad5400b4806d438a16a61517` | Concise extract of `baseline_unambiguous_frozen_manifest.csv`; full source-manifest SHA-256 `416949addd664d6e89230df00fc1e89adad261b51268f24f60cd42770559e217` |
...
- Table S6 is a concise, source-identifier-preserving extract of the frozen model-eligible baseline manifest, not the complete set of 111 validated cases. The full evidence snippets remain in the source workflow artifact.
