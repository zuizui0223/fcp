...
At the primary 0.10 tier, **158** species produced admissible nonzero displacement vectors. Observed W was **0.517**. The isotropic eight-dimensional expectation is 0.125, but the decisive reference is the frozen coarse-morph-composition-preserving structured null, whose median was **0.457** (95% interval 0.436–0.475). Observed W was 1.1315 times that baseline, with upper-tail p = **0.001**. The prospective result therefore confirms excess continuous alignment beyond the construction baseline, not the white/nonwhite direction considered in isolation.
...
The frozen terminal verdict remains `H2_PROSPECTIVE_WHITE_AXIS_CONFIRMED`. It is a prospective species-disjoint test within the same iNaturalist source/opportunity universe, not an independent-source replication.

### Post-confirmatory H2 validity diagnostics

White was one of the two leading coarse morphs in **137 of 158 species (86.7%)**. Mean species-level `(u_i · q_white)^2` was **0.562** in those species and **0.224** otherwise. A 299-world diagnostic that began from the 185 coarse-gate species and reapplied the continuous minor-cluster gate in every null world gave median W = **0.4475** and p = **0.00333**, showing that the frozen conditional null (median 0.457) was not anti-conservative under this gate sensitivity.

A separate background-enabled reserve resource showed higher within-species median background-white fractions for white-classified than nonwhite-classified images (0.0692 versus 0.0553 across **461** paired species; 66.4% in the same direction; paired Wilcoxon p = **4.55 × 10^-12**). This proxy is compatible with brightness/exposure coupling but is not a direct exposure test; biological background differences, framing and ROI/mask leakage remain alternatives. The previously frozen P500 clipping/luminance control was not executed for this cohort. These post-confirmatory diagnostics constrain interpretation without changing the frozen prospective H2 decision.
...
The strongest positive geometric result is narrower than a comparison with isotropy suggests. The structured null median of 0.457 is already far above the isotropic expectation of 0.125 because coarse white/nonwhite combinations impose substantial achromatic–chromatic structure. The observed W of 0.517 exceeds that baseline. The prospectively supported quantity is therefore the **increment of continuous alignment conditional on coarse morph composition**.

The target was frozen before the third cohort was opened, and both admissibility tiers exceeded their structured nulls. Projection of q_white out of the legacy cohorts removed the excess directional concentration, while non-white-only diagnostics did not support a recurrent hue axis. The result is therefore a narrow geometric regularity rather than a general shared colour-space direction.

### Measurement validity of the white state remains unresolved

The structured null cannot diagnose a measurement process that helps create the coarse white classification itself because coarse state is preserved by construction. White was involved in 137 of 158 primary H2 species, and a separate background-enabled resource showed systematically whiter backgrounds for white-classified images within species. That association is consistent with a brightness/exposure concern but can also arise from biological background differences, framing or segmentation leakage.

The P500 programme had frozen non-circular clipping and luminance diagnostics, but that protocol was never executed for the successful third cohort and cannot retrospectively become a prospective gate. Until a direct post hoc highlight check is available, q_white should be interpreted as an image-derived colour axis rather than direct evidence about floral reflectance or pigment chemistry.

### What the achromatic–chromatic axis does not identify

The white-versus-nonwhite geometry is descriptive, not mechanistic. Pollinator-mediated selection, abiotic selection, drift, gene flow, mating system and pigment genetics can all contribute in different systems (Sapir et al. 2021; Narbona et al. 2018). These analyses do not identify pigment chemistry, evolutionary direction, or the mechanism maintaining the observed colour states.

The construction-preserving null shows that continuous displacement alignment exceeds the baseline generated while preserving coarse morph composition and its global palette mapping. It does not identify why the coarse white state exists and cannot exclude measurement processes that act upstream of that classification.
...
This result is structural rather than causal. Stronger geographic organization could arise from spatially varying abiotic selection, turnover in pollinator communities, restricted dispersal or gene flow, demographic history, drift, mating-system differences, or combinations of these processes. The current photographs and occurrence geometry cannot distinguish among them. Together with the prospective excess achromatic–chromatic alignment, the evidence suggests a two-stage descriptive framework: image-derived colour variation is concentrated along an achromatic–chromatic direction, while species-specific ecological and demographic processes may determine how strongly variants are maintained or sorted across space. The first component is the H2 geometric result; the second remains a mechanistic hypothesis motivated by the replicated D–spatial association.
