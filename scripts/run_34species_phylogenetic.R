...
manifest <- list(
  status="complete", dataset_role="frozen_34_species_baseline_only", n_species=34L,
  min_cells=args$min_cells, metrics=METRICS, model_formula="among ~ metric_z + effort_z",
...
print(coll); print(open_summary); print(dated)
