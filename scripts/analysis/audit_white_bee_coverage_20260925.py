...
def main():
    ...
    read_kw={'encoding':'utf-8','encoding_errors':'replace'}
    header=pd.read_csv(a.bee_curated,nrows=0,**read_kw)
    ...
    all_plants=set()
    scanned_rows=0
    for chunk in pd.read_csv(a.bee_curated,usecols=['plant_species'],chunksize=a.chunksize,low_memory=False,**read_kw):
    ...
    result={
      ...
      'decoder':'utf-8 with replacement of invalid bytes; exact matching uses normalized species strings',
