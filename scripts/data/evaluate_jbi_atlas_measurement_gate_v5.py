...
def main() -> int:
    ...
    decision["claim_ceiling"] = (
        "Measurement completeness only; coordinates remain sealed and no spatial, "
        "shared-transition, environmental or pollinator result is permitted."
    )
    ...
    return 0 if decision["coordinate_join_permitted"] else 2
